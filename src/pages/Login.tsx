...
const Login = () => {
  ...
  const fromRegister = window.history.state && window.history.state.usr && window.history.state.usr.fromRegister;
      ...
      <div className="flex min-h-screen flex-1">
        ...
        <div className="relative hidden w-0 flex-1 lg:block">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-10 text-white z-10">
            ...
            <p className="text-lg text-gray-200">Streamline your workflow, track bugs efficiently, and deliver software faster.</p>
          </div>
        </div>
        ...
        <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24 bg-white">
          <div className="mx-auto w-full max-w-sm lg:w-96">
            ...
            <div>
              <h1 className="text-[#111318] tracking-light text-[32px] font-bold leading-tight text-center pb-2">
                {fromRegister ? 'Welcome Back' : 'Login to Your Account'}
              </h1>
              <p className="text-[#616f89] text-base font-normal leading-normal text-center pb-8">Sign in to manage your tickets</p>
            </div>
            ...
            <div className="mt-2">
                ...
                <div>
                  <label className="block" htmlFor="password">
                    <div className="flex items-center justify-between pb-2">
                      <p className="text-[#111318] text-base font-medium leading-normal">Password</p>
                    ...
                    <div className="flex w-full items-stretch rounded-lg shadow-sm">
                      ...
                      />
                      <div
                        className="text-[#616f89] flex border border-[#dbdfe6] bg-white items-center justify-center pr-[15px] pl-2 rounded-r-lg border-l-0 cursor-pointer hover:text-primary transition-colors"
              ...
              <div className="mt-6 text-center">
                <p className="text-[#616f89] text-base">
                  ...
                  <a className="font-semibold text-blue-500 hover:text-blue-700 transition-colors" href="/register">Register now</a>
                </p>
              </div>
            </div>
          </div>
